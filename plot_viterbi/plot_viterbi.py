...
length_chr = float(marker_location_data[len(marker_location_data)-1])#the position (must be in physical distance) of the last SNPs is interpreted as the length of the chromosome.
number_individual=len(viterbi_data[0])
